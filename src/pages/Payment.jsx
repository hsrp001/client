...
<div class="min-w-screen min-h-screen bg-gray-50 flex items-center justify-center px-5 pb-10 pt-16 mt-28 ">
    <div class="w-full mx-auto rounded-lg bg-white shadow-lg p-5 text-gray-700 max-w-[650px]">
